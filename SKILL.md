...
description: Reads the current git branch diff and writes a complete GitHub pull request description: summary, changes, and testing notes. Optionally creates or updates the PR. Use when asked to write a PR description, draft a pull request, generate PR notes, fill in the PR body, or describe what a branch changes. Trigger when a user says "write a PR description", "draft my PR", "describe this branch", "what should I put in my PR", or opens a PR and wants the body filled in.
